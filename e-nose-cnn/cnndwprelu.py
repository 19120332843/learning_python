...
if __name__ == '__main__':
    ...
    for epoch in range(300):
        ...
        if (sum / total_train > 0.85) :
            optimizer = optim.SGD(cnn.parameters(), lr=lrr/lrdel, momentum=mom/momdel)
        elif (sum / total_train > 0.95) :
            optimizer = optim.SGD(cnn.parameters(), lr=lrr/lrdel/lrdel, momentum=mom/momdel/momdel)#momentum=0
